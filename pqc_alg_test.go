...
func TestSnova(t *testing.T) {
	//crear una clave privada que sea compatible con SNOVA.
	sigName := "SNOVA_24_5_4"
	signer := oqs.Signature{}
	defer signer.Clean()
...
func TestSnovaShake(t *testing.T) {
	//crear una clave privada que sea compatible con SNOVA.
	sigName := "SNOVA_24_5_4_SHAKE"
	signer := oqs.Signature{}
	defer signer.Clean()
